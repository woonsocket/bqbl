...
const scheduleMap = {"ARI": ["@DET", "@IND", "DAL", "SF", "@PHI", "TB", "@LAR", "BYE", "@SF", "SEA", "@HOU", "JAX", "LAR", "TEN", "@WSH", "NYG", "@SEA"],
...
"DAL": ["NYG", "@DEN", "@ARI", "LAR", "GB", "BYE", "@SF", "@WSH", "KC", "@ATL", "PHI", "LAC", "WSH", "@NYG", "@OAK", "SEA", "@PHI"],
...
"HOU": ["JAX", "@CIN", "@NE", "TEN", "KC", "CLE", "BYE", "@SEA", "IND", "@LAR", "ARI", "@BAL", "@TEN", "SF", "@JAX", "PIT", "@IND"],
"IND": ["@LAR", "ARI", "CLE", "@SEA", "SF", "@TEN", "JAX", "@CIN", "@HOU", "PIT", "BYE", "TEN", "@JAX", "@BUF", "DEN", "@BAL", "HOU"],
"JAX": ["@HOU", "TEN", "BAL", "@NYJ", "@PIT", "LAR", "@IND", "BYE", "CIN", "LAC", "@CLE", "@ARI", "IND", "SEA", "HOU", "@SF", "@TEN"],
"KC": ["@NE", "PHI", "@LAC", "WSH", "@HOU", "PIT", "@OAK", "DEN", "@DAL", "BYE", "@NYG", "BUF", "@NYJ", "OAK", "LAC", "MIA", "@DEN"],
"LAR": ["IND", "WSH", "@SF", "@DAL", "SEA", "@JAX", "ARI", "BYE", "@NYG", "HOU", "@MIN", "NO", "@ARI", "PHI", "@SEA", "@TEN", "SF"],
...
"MIN": ["NO", "@PIT", "TB", "DET", "@CHI", "GB", "BAL", "@CLE", "BYE", "@WSH", "LAR", "@DET", "@ATL", "@CAR", "CIN", "@GB", "CHI"],
"NE": ["KC", "@NO", "HOU", "CAR", "@TB", "@NYJ", "ATL", "LAC", "BYE", "@DEN", "@OAK", "MIA", "@BUF", "@MIA", "@PIT", "BUF", "NYJ"],
"NO": ["@MIN", "NE", "@CAR", "@MIA", "BYE", "DET", "@GB", "CHI", "TB", "@BUF", "WSH", "@LAR", "CAR", "@ATL", "NYJ", "ATL", "@TB"],
"NYG": ["@DAL", "DET", "@PHI", "@TB", "LAC", "@DEN", "SEA", "BYE", "LAR", "@SF", "KC", "@WSH", "@OAK", "DAL", "PHI", "@ARI", "WSH"],
...
"PHI": ["@WSH", "@KC", "NYG", "@LAC", "ARI", "@CAR", "WSH", "SF", "DEN", "BYE", "@DAL", "CHI", "@SEA", "@LAR", "@NYG", "OAK", "DAL"],
"PIT": ["@CLE", "MIN", "@CHI", "@BAL", "JAX", "@KC", "CIN", "@DET", "BYE", "@IND", "TEN", "GB", "@CIN", "BAL", "NE", "@HOU", "CLE"],
"SF": ["CAR", "@SEA", "LAR", "@ARI", "@IND", "@WSH", "DAL", "@PHI", "ARI", "NYG", "BYE", "SEA", "@CHI", "@HOU", "TEN", "JAX", "@LAR"],
"SEA": ["@GB", "SF", "@TEN", "IND", "@LAR", "BYE", "@NYG", "HOU", "WSH", "@ARI", "ATL", "@SF", "PHI", "@JAX", "LAR", "@DAL", "ARI"],
"TB": ["@MIA", "CHI", "@MIN", "NYG", "NE", "@ARI", "@BUF", "CAR", "@NO", "NYJ", "@MIA", "@ATL", "@GB", "DET", "ATL", "@CAR", "NO"],
"TEN": ["OAK", "@JAX", "SEA", "@HOU", "@MIA", "IND", "@CLE", "BYE", "BAL", "CIN", "@PIT", "@IND", "HOU", "@ARI", "@SF", "LAR", "JAX"],
"WSH": ["PHI", "@LAR", "OAK", "@KC", "BYE", "SF", "@PHI", "DAL", "@SEA", "MIN", "@NO", "NYG", "@DAL", "@LAC", "ARI", "DEN", "@NYG"],}
